...
public class Interface extends javax.swing.JFrame {
    ...
    public Interface(ArrayList<Process> processList) {
        initComponents();
        setLocationRelativeTo(null);
        enableButtons();
    ...
    private void initComponents() {
        ...
        processsTable = new javax.swing.JTable();
        ...
        jLabel6.setText("Current process :");

        labelCurrentProcess.setFont(new java.awt.Font("Lucida Grande", 0, 17)); // NOI18N
        labelCurrentProcess.setText("0");
        ...
        radioButtonSJF.setText("Shortest process First");
        ...
        jLabel9.setText("processs ");

        jScrollPane2.setPreferredSize(new java.awt.Dimension(960, 404));

        processsTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "process No", "Arrive", "Burst Time", "Start Time", "Wait Time", "Remaining Time", "Finish Time", "Turnaround"
            }
        ) {
        ...
        processsTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane2.setViewportView(processsTable);
    ...
    private void buttonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonResetActionPerformed
        ...
        Interface face = new Interface(processList);
    ...
    private javax.swing.JTable processsTable;
    ...
    private void addCell(int processNum) {
        Cell cell = new Cell(processNum);
    ...
    private void setTableData(ArrayList<Process> processList) {
        ...
        DefaultTableModel tableModel = (DefaultTableModel) processsTable.getModel();
        Object rowData[] = new Object[8];

        processList.forEach(process -> {
            rowData[0] = process.getprocessNum();
            rowData[1] = process.getArrivalTime();
            rowData[2] = process.getBurstTime();
            rowData[3] = process.getStartTime();
            rowData[4] = process.getWaitTime();
            rowData[5] = process.getRemainingTime();
            rowData[6] = process.gettimeFinished();
            rowData[7] = process.getTurnAroundTime();
    ...
    private void updateLabels(Process process) {

        if (process.getprocessNum() < 11 && process.getprocessNum() > 0) {
            labelCurrentProcess.setText("process " + process.getprocessNum());
        } else if (process.getprocessNum() == 11) {
            labelCurrentProcess.setText("waiting");
        } else if (process.getprocessNum() == 0) {
            labelCurrentProcess.setText("finished");
            calculateAverages();
            allprocesssDone = true;
            if(animator != null){
                animator.setAllprocesssDone(true);
            }
            buttonNextStep.setEnabled(false);
