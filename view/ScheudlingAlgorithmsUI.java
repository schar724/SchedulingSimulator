 ...
 * @author scott
 */
public class ScheudlingAlgorithmsUI extends javax.swing.JFrame {

    /**
     * Creates new form ScheudlingAlgorithmsUI
     */
    public ScheudlingAlgorithmsUI() {
        initComponents();
    }
    ...
    private void runMouseClicked(java.awt.event.MouseEvent evt) {                                 
                ...
                p1ArrivalTime = Integer.parseInt(processData.getValueAt(0, 1).toString());
                p1BurstTime = Integer.parseInt(processData.getValueAt(0, 2).toString());
                p2ArrivalTime = Integer.parseInt(processData.getValueAt(1, 1).toString());
                p2BurstTime = Integer.parseInt(processData.getValueAt(1, 2).toString());
                p3ArrivalTime = Integer.parseInt(processData.getValueAt(2, 1).toString());
                p3BurstTime = Integer.parseInt(processData.getValueAt(2, 2).toString());
                p4ArrivalTime = Integer.parseInt(processData.getValueAt(3, 1).toString());
                p4BurstTime = Integer.parseInt(processData.getValueAt(3, 2).toString());
                p5ArrivalTime = Integer.parseInt(processData.getValueAt(4, 1).toString());
                p5BurstTime = Integer.parseInt(processData.getValueAt(4, 2).toString());
                p6ArrivalTime = Integer.parseInt(processData.getValueAt(5, 1).toString());
                p6BurstTime = Integer.parseInt(processData.getValueAt(5, 2).toString());
                p7ArrivalTime = Integer.parseInt(processData.getValueAt(6, 1).toString());
                p7BurstTime = Integer.parseInt(processData.getValueAt(6, 2).toString());
                p8ArrivalTime = Integer.parseInt(processData.getValueAt(7, 1).toString());
                p8BurstTime = Integer.parseInt(processData.getValueAt(7, 2).toString());

                System.out.println(quantum);
                System.out.println(selectedAlgorithm);
                System.out.println(p1ArrivalTime);
                System.out.println(p1BurstTime);
                System.out.println(p2ArrivalTime);
                System.out.println(p2BurstTime);
                System.out.println(p3ArrivalTime);
                System.out.println(p3BurstTime);
                System.out.println(p4ArrivalTime);
                System.out.println(p4BurstTime);
                System.out.println(p5ArrivalTime);
                System.out.println(p5BurstTime);
                System.out.println(p6ArrivalTime);
                System.out.println(p6BurstTime);
                System.out.println(p7ArrivalTime);
                System.out.println(p7BurstTime);
                System.out.println(p8ArrivalTime);
                System.out.println(p8BurstTime);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScheudlingAlgorithmsUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScheudlingAlgorithmsUI().setVisible(true);
            }
        });
    }
    ...
    private int quantum;
    private int p1ArrivalTime;
    private int p1BurstTime;
    private int p2ArrivalTime;
    private int p2BurstTime;
    private int p3ArrivalTime;
    private int p3BurstTime;
    private int p4ArrivalTime;
    private int p4BurstTime;
    private int p5ArrivalTime;
    private int p5BurstTime;
    private int p6ArrivalTime;
    private int p6BurstTime;
    private int p7ArrivalTime;
    private int p7BurstTime;
    private int p8ArrivalTime;
    private int p8BurstTime;
